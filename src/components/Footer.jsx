...
const Footer = () => {
  const nav_links = [
    { name: "About", link: "/about-digipath-conclave"},
    { name: "Executive Panel", link: "/executive-panel-members/" },
    { name: "Tracks", link:"/digipath-conference-tracks/"},
    { name: "Orators", link:  "/digi-orators"},
    { name: "Schedule", link:  "/digipath-event-schedule"},
  ...
  return (
    <div className="flex flex-col rounded-t-2xl md:flex-row md:justify-between bg-accent/40 px-4 sm:px-6 md:px-12 py-8 md:py-10 text-white gap-10 md:gap-6 items-start md:items-stretch">
      ...
      <div className="w-full md:w-1/4 flex flex-col mt-[10px] items-center md:items-start text-center md:text-left gap-4">
        <div className=" pt-10 p-4 rounded-xl">
          ...
          <br />
        <p style={{}}>
   “Advancing Research into AI-Powered Diagnostic Excellence”
        </p>
