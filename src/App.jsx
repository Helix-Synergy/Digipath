  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path=  "/digi-orators"element={<Orators />} />
        <Route path= "/about-digipath-conclave" element={<AboutOralMed />} />
        <Route path="/digipath-event-schedule" element={<EventSchedule />} />
        <Route path="/venue" element={<Venue/>}/>
        <Route path="/contact" element={<ContactForm />} />
        <Route path="/digipath-conference-tracks/"element={<RotatingLogos />} />
