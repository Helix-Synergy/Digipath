...
const data = {
 ...
 The World Conference on Digital Pathology & AI-Driven Diagnostics, organized by <Link
        ...
        >Helix Conferences,</Link>
         is a distinguished international forum dedicated to advancing digital pathology workflows, computational imaging, artificial intelligence applications, and next-generation diagnostic technologies that enhance accuracy, efficiency, and patient outcomes.
The conference is designed to facilitate high-level knowledge exchange, interdisciplinary collaboration, and evidence-based discussions that accelerate the adoption of digital pathology and AI-enabled diagnostic systems. Emphasis is placed on whole slide imaging, computational pathology, machine learning and deep learning models, biomarker discovery, precision oncology, laboratory automation, interoperability, and regulatory standards.
Through plenary sessions, keynote addresses, expert-led panels, technical workshops, and scientific research presentations, participants will gain strategic insights into emerging diagnostic technologies, scalable digital pathology platforms, and evolving global healthcare policies.
      </>,
      <>
  ...
  join: [
    {
      ...
      // link: "/",
      suffix:
       "Join global leaders and innovators in shaping the future of diagnostic medicine through digital pathology excellence..",
    },
  ],
highlights: [
  {
    ...
    description:
      "Engage with internationally recognized experts and thought leaders in digital pathology, AI-driven diagnostics, and precision medicine.",
  },
  {
    title: "Technical Workshops & Expert Sessions",
    description:
      "Participate in in-depth sessions focused on whole slide imaging, AI model development, workflow digitization, quality assurance, and clinical validation.",
  },
  {
    title: "Innovation & Technology Exhibition",
    description:
      "Discover advanced digital pathology platforms, AI-powered diagnostic tools, laboratory automation systems, and clinical decision support technologies.",
  },
  {
    title: "Strategic Networking Opportunities",
    description:
      "Build meaningful connections with global stakeholders across academia, healthcare institutions, technology companies, regulatory bodies, and investment sectors.",
  },
  {
    title: "Precision Diagnostics, AI & Data Integrity Focus",
    description:
      "Gain insights into clinical-grade AI deployment, data governance, regulatory compliance, and ethical AI in pathology.",
  },
  {
    title: "Scientific & Market Intelligence",
    description:
      "Explore the latest research findings, commercialization trends, and adoption pathways in digital pathology and computational diagnostics.",
  ...
  },
  {
    ...
    description:
      "Foster cross-sector partnerships to advance research, clinical translation, and scalable diagnostic solutions.",
  },
  {
    title: "Professional Development & Accreditation",
    description:
      "Earn professional development recognition through certified learning sessions, hands-on workshops, and technical training programs.",
  },
],
...
Fostering Collaboration Driving Transformative Healthcare Innovation.
      ...
      <section className="mb-10 text-center w-full min-w-4xl px-2 md:px-12 lg:px-24">
        <h2 className="text-3xl font-bold text-one mb-4 w-full">
          Join the Global Community at on DIGIPATH-2026
        </h2>
      ...
      <section className="mb-16 text-center w-full px-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          Pathology & AI Experts
            </h3>
          </div>
          <div className="bg-white rounded-xl shadow px-4 py-6 flex flex-col items-center hover:shadow-lg transition">
            <BookOpen className="h-10 w-10 text-one mb-3" />
            <h3 className="text-lg font-semibold text-gray-800 mb-1">
     Digital Diagnostics Professionals
            </h3>
          </div>
          <div className="bg-white rounded-xl shadow px-4 py-6 flex flex-col items-center hover:shadow-lg transition">
            <Rocket className="h-10 w-10 text-one mb-3" />
            <h3 className="text-lg font-semibold text-gray-800 mb-1">
         Computational Pathology Leaders
            </h3>
          </div>
          <div className="bg-white rounded-xl shadow px-4 py-6 flex flex-col items-center hover:shadow-lg transition">
